...
# Outputs: pE_dbrda (ggplot object), dbrda.pdf/.png
...
write.csv(audit_df, file.path(DAT_DIR, "dbrda.csv"),
          row.names = FALSE)

ggsave(file.path(RPT_DIR, "dbrda.pdf"), pE_dbrda,
       width = PE_RDA_W, height = PE_RDA_H, units = "mm", device = pdf_device)
ggsave(file.path(RPT_DIR, "dbrda.png"), pE_dbrda,
