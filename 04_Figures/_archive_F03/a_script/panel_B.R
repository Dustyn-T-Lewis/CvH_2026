# F03 Panel B: Concordance Scatter — logFC Training_CRE vs Training_PLA
...
ggsave(file.path(RPT, "panel_B_concordance.pdf"), pD,
       width = PD_W, height = PD_W, units = "mm", device = pdf_device)
ggsave(file.path(RPT, "panel_B_concordance.png"), pD,
