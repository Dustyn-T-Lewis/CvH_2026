# F03 CR — Composite: A|B top, C|D bottom (2x2)
...
COMP_W <- 340; COMP_H <- 300

ggsave(file.path(RPT, "F03_CR_dep_pathway_MAIN.pdf"), composite,
       width = COMP_W, height = COMP_H, units = "mm",
       device = pdf_device, limitsize = FALSE)
ggsave(file.path(RPT, "F03_CR_dep_pathway_MAIN.png"), composite,
       width = COMP_W, height = COMP_H, units = "mm",
       dpi = 300, limitsize = FALSE)

cat("F03 CR composite saved\n")
