...
# Step 1: Main composite FIRST (before supp loads AnnotationDbi which masks dplyr::select)
message("\n--- Step 1: Main composite ---")
source("04_Figures/Reversal/a_script/main/90_stitch_main.R")

# Step 2: Supplementary composite (AnnotationDbi masking OK — supp scripts use dplyr:: prefix)
