# F05 CRvH Panel F_fry -- fry Rotation Test: CvH Concordance Barcode
...
# Build contrast vector manually (averaging over CR subgroups)
...
message("F05 CRvH Panel F (fry) done")
