...
fry_c_up <- run_fry_generic(mat_cr, design_cr, cm_tr[, "CR_Training"],
...
fry_c_dn <- run_fry_generic(mat_cr, design_cr, cm_tr[, "CR_Training"],
                              meta_cr$Subject_ID, cor_cr,
...
fry_t_up <- run_fry_generic(mat, design_all, cm_cvh[, "CRvH_Baseline"],
...
fry_t_dn <- run_fry_generic(mat, design_all, cm_cvh[, "CRvH_Baseline"],
                              meta_all$Subject_ID, cor_all,
