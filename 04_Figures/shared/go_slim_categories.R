...
# Display order and palette for the 15 consolidated categories. This is the only
# definition; pathway_utils.R carried an identical unused copy until 2026-07-27.
...
assign_go_slim_consolidated <- function(fg_genes, all_genes, min_cat_size = 2) {
  suppressMessages({
    all_entrez <- AnnotationDbi::mapIds(org.Hs.eg.db,
      keys = all_genes,
