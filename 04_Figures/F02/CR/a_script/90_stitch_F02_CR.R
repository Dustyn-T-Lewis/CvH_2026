# F02 CR — Composite: PCA + logFC Density
...
RPT <- "04_Figures/F02/CR/b_reports"
...
COMP_W <- 260; COMP_H <- 200

ggsave(file.path(RPT, "F02_CR_proteome_MAIN.pdf"), composite,
       width = COMP_W, height = COMP_H, units = "mm",
       device = pdf_device, limitsize = FALSE)
ggsave(file.path(RPT, "F02_CR_proteome_MAIN.png"), composite,
       width = COMP_W, height = COMP_H, units = "mm",
       dpi = 300, limitsize = FALSE)

cat("F02 CR composite saved\n")
