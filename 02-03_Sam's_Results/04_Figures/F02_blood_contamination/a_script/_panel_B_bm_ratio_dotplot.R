...
write_csv(panel_B_data,
          "02-03_Sam's_Results/04_Figures/F02_blood_contamination/c_data/panel_B_dotplot_data.csv")
...
ggsave("02-03_Sam's_Results/04_Figures/F02_blood_contamination/b_reports/main/png/panels/panel_B.png",
