...
write_csv(supp_D_data,
          "02-03_Sam's_Results/04_Figures/F02_blood_contamination/c_data/supp_D_blood_markers_DEP.csv")
...
ggsave("02-03_Sam's_Results/04_Figures/F02_blood_contamination/b_reports/supp/png/panels/supp_D.png",
