...
write_csv(panel_D_proteins,
  "02-03_Sam's_Results/04_Figures/F02_blood_contamination/c_data/panel_D_venn_protein_sets.csv")
...
write_csv(panel_D_markers,
  "02-03_Sam's_Results/04_Figures/F02_blood_contamination/c_data/panel_D_venn_blood_markers.csv")
...
out_png <- "02-03_Sam's_Results/04_Figures/F02_blood_contamination/b_reports/main/png/panels/panel_D.png"
